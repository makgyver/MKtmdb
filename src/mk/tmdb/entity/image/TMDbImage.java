 ...
 *
 */
public abstract class TMDbImage extends TMDbEntity {
	 ...
	 */
	public TMDbImage(JSONObject json) {
		super(json);
		parseJSON(json);
	}
	...
	private boolean parseJSON(JSONObject json) {
		...
		try {
			setPath(json.getString(TMDbConstants.PATH));
			setWidth(json.getInt(TMDbConstants.WIDTH));
			setHeight(json.getInt(TMDbConstants.HEIGHT));
			setIso639_1(json.getString(TMDbConstants.ISO_6391));
			setAspectRatio(json.getDouble(TMDbConstants.RATIO));
			setAverage(json.getDouble(TMDbConstants.AVERAGE));

 ...
 *
 */
public class TMDbCrew extends TMDbRole {
	 ...
	 */
	public TMDbCrew(JSONObject json) {
		super(json);
		parseJSON(json);
	}
	...
	private boolean parseJSON(JSONObject json) {
		...
		setDepartment(json.getString(TMDbConstants.DEPARTMENT));
